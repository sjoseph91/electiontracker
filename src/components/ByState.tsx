...
function ByState(props) {
    ...
    const baseUrl =
        'https://api.open.fec.gov/v1/presidential/contributions/by_state/'
    ...
    return (
        <main className={`${candidate}-theme`}>
            <h2>
                Total spent in {selectedState} : {formatter.format(total)}{' '}
            </h2>
            <USAMap onClick={mapHandler} defaultFill="rgb(129,129,130)" />
        </main>
    )
}
