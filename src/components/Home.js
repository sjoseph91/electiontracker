        ...
        <main>
            ...
            <div className="images">
                ...
                <Link to="/options" onClick={() =>handleClick("biden")}>
                    <img  src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/20/Joe_Biden_official_portrait_2013_cropped.jpg/220px-Joe_Biden_official_portrait_2013_cropped.jpg" width="200px" alt="biden"></img>
                </Link>
